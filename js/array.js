...
const artists = [
    ...
    //펌펌
    [`${root}ohohaoho_01.png`,`${root}ohohaoho_02.png`,`${root}ohohaoho_03.png`,`${root}ohohaoho_04.png`,"ADORABLE HORROR!<br>온 아나 아노","ohohaoho.official@gmail.com ","./img/Thumnail/Thumnail_ohohaoho.jpg","https://www.instagram.com/ohohaoho","","ADORABLE HORROR!"],
    //온 아나 아노
    ...
    //은국
    ["./img/artist/lkl_01.jpeg","./img/artist/lkl_02.jpeg","./img/artist/lkl_03.jpeg","./img/artist/lkl_04.jpeg","live kyuseon lee<br>라큐리의 컴퓨터세상","kyuseon_lee@naver.com ","./img/Thumnail/Thumnail_live-kyuseon-lee.jpeg","https://www.instagram.com/live_computer_center_lee","","라큐리의 컴퓨터세상"],
    //라큐리
        ...
        if(item === 0 || item){
            artist_contents.push(`<div id="popup_contents">`);
                ...
                artist_contents.push(`<div id="popup_contact">`);
                    artist_contents.push(`<p id="p_contact">CONTACT</p>`);
